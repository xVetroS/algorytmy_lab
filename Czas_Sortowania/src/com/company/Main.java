            ...
            switch(wybor){
                case 1:
                    for (int liczba_pliku = 1; liczba_pliku <= 10; liczba_pliku++) {
                        try {
                            Files.createFile(Paths.get("C:\\Labik\\Czas_Sortowania\\src\\com\\company\\" + nazwa_zbioru3 + liczba_pliku + ".txt"));
                    ...
                    for(petla1=1; petla1<11; petla1++) {
                       ...
                       List<Integer> losowe1 =  generator_liczb.generowanie_losowych(ilosc_elementow1/2);
                        List<Integer> losowe11 =  generator_liczb.generowanie_losowych(ilosc_elementow3/2);
                        sortowanie_zbioru.selectionsort(losowe1);
                        List<Integer> suma = new ArrayList<>();
                        suma = losowe1;
                        suma.addAll(losowe11);
                        System.out.println();
                        PrintWriter zapisz = new PrintWriter("C:\\Labik\\Czas_Sortowania\\src\\com\\company\\" + nazwa_zbioru3 + petla1 + ".txt");
                        for (int y = 0; y < suma.size(); y++) {
                            zapisz.write(Integer.toString(suma.get(y)) + " ");
                        }
                        zapisz.close();
                    }
                    for(int y=1; y<=10; y++)
                    {
                        ...
                        sz.wypisz_dane_z_pliku(nazwa_zbioru3, y, 5);
                    }
                    break;
                case 2:
                    for (int liczba_pliku = 1; liczba_pliku <= 10; liczba_pliku++) {
                        try {
                            Files.createFile(Paths.get("C:\\Labik\\Czas_Sortowania\\src\\com\\company\\" + nazwa_zbioru2 + liczba_pliku + ".txt"));
                    ...
                    for(petla2=1; petla2<11; petla2++) {
                        ...
                        List<Integer> losowe2 = generator_liczb.generowanie_losowych(ilosc_elementow2);
                        System.out.println();
                        PrintWriter zapisz = new PrintWriter("C:\\Labik\\Czas_Sortowania\\src\\com\\company\\" + nazwa_zbioru2 + petla2 + ".txt");
                        for (int y = 0; y < losowe2.size(); y++) {
                            zapisz.write(Integer.toString(losowe2.get(y)) + " ");
                        }
                        zapisz.close();
                    }
                    for(int y=1; y<=10; y++)
                    {
                        ...
                        System.out.print("Dane: ");
                        sz.wypisz_dane_z_pliku(nazwa_zbioru2, y, 5);
                    }
                    break;
                case 3:
                    for (int liczba_pliku = 1; liczba_pliku <= 10; liczba_pliku++) {
                        try {
                            Files.createFile(Paths.get("C:\\Labik\\Czas_Sortowania\\src\\com\\company\\" + nazwa_zbioru1 + liczba_pliku + ".txt"));
                    ...
                    for(petla3=1; petla3<11; petla3++) {
                        ...
                        List<Integer> losowe3 =  generator_liczb.generowanie_losowych(ilosc_elementow3);
                        sortowanie_zbioru.selectionsort(losowe3);
                        sortowanie_zbioru.swap(losowe3);
                        for(int i = 0; i<losowe3.size(); i++) {
                            System.out.print(losowe3.get(i) + " ");
                        }
                        System.out.println();
                        PrintWriter zapisz = new PrintWriter("C:\\Labik\\Czas_Sortowania\\src\\com\\company\\" + nazwa_zbioru1 + petla3 + ".txt");
                        for (int y = 0; y < losowe3.size(); y++) {
                            zapisz.write((losowe3.get(y).toString()) + " ");
                        }
                        zapisz.close();
                    }
                        for(int y=1; y<=10; y++)
                        {
                            ...
                            System.out.print("Dane: ");
                            sz.wypisz_dane_z_pliku(nazwa_zbioru1, y, 5);
                        }
                    break;
            ...
            switch(wybor)
            {
                case 1:
                    for(nr_plik=1; nr_plik<=10; nr_plik++) {
                        ...
                        try {
                            sz.wypisz_dane_z_pliku(nazwa_zbioru3, nr_plik, wybor);
                        }
                        ...
                        try {
                            sz.wypisz_dane_z_pliku(nazwa_zbioru2, nr_plik, wybor);
                        } catch(FileNotFoundException e)
                        {
                            System.out.println("Nie ma takiego pliku!");
                        }
                        ...
                        try {
                            sz.wypisz_dane_z_pliku(nazwa_zbioru1, nr_plik, wybor);
                        }catch(FileNotFoundException e)
                        {
                            System.out.println("Nie ma takiego pliku!");
                        }
